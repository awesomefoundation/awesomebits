def initialize_databases(old_db_yaml_file, new_db_yaml_file)

  ActiveRecord::Base.configurations["new_database"] = YAML.load_file(new_db_yaml_file)
  # {
  #   adapter: "postgresql",
  ...
  ActiveRecord::Base.configurations["old_database"] = YAML.load_file(old_db_yaml_file)
  # {
  #   adapter: "mysql2",
